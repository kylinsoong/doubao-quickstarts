...
chapters = ["康复医疗行业国内市场规模如何", "从总产值、增速、从业人员等多个基本面进行描",  "康复医疗行业的产业链由哪几部分构成", "各自部分的龙头企业都有哪些", "康复医疗行业的发展历程,各重要节点发布政策解读", "康复医疗行业的市场趋势如何？市场的活跃程度以及基本面表现如何？", "康复医疗行业的市场趋势如何？市场的活跃程度以及基本面表现如何？", "康复医疗行业世界总市场规模如何？从总产值、增速、从业人员等多方向进行描述?", "我国康复医疗行业市场情况与世界平均表现对比，优劣势各是什么"]
