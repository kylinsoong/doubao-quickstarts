...
chapters = ["为什么减肥总是失败？重新理解“肥胖”这件事", "减肥的原理,热量赤字与身体平衡", "减肥与饮食，科学饮食的减脂策略", "减肥与运动，动起来才有燃脂效率", "减肥不只是身体的事，更是心理战,坚持才是王道"]
...
def generate_chapter(prompt):
    ...
    BOT_ID = os.environ.get("ARK_BOT_ID")
