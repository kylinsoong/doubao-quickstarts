...
# 导入提示词
try:
    from prompt import VISUAL_RISK_CONTROL_AGENT_PROMPT
...
# 智能体配置
agent_name = "visual_risk_control_agent"
description = "视觉风险控制智能体，用于检测和分析图片中的风险内容"
system_prompt = VISUAL_RISK_CONTROL_AGENT_PROMPT
tools = []

# 创建智能体
visual_risk_control_agent = Agent(
    name=agent_name,
...
root_agent = visual_risk_control_agent
