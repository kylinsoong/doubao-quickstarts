...
This file wraps your Agent definition (intent_identity_agent.py) to make it deployable with AgentKit.

Your Agent is imported from: intent_identity_agent
...
from intent_identity_agent import agent
