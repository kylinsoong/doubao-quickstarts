...
This file wraps your Agent definition (quality_check_agent.py) to make it deployable with AgentKit.

Your Agent is imported from: quality_check_agent
...
from quality_check_agent import agent
