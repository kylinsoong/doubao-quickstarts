...
This file wraps your Agent definition (sentiment_tag_agent.py) to make it deployable with AgentKit.

Your Agent is imported from: sentiment_tag_agent
...
from sentiment_tag_agent import agent
